...
/**
 * Block conversion handler for html_placeholders
 */
class moodle1_block_html_placeholders_handler extends moodle1_block_handler {
    ...
    protected function convert_configdata(array $olddata) {
        ...
        $this->fileman = $this->converter->get_file_manager($contextid, 'block_html_placeholders');
