...
/**
 * Unit tests for the block_html_placeholders implementation of the privacy API.
 *
...
use \block_html_placeholders\privacy\provider;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html_placeholders GNU GPL v3 or later
 */
class block_html_placeholders_privacy_testcase extends \core_privacy\tests\provider_testcase {
    /**
    ...
    protected function create_user_block($title, $body, $format) {
        ...
        $block = block_instance('html_placeholders', $block->instance);
    ...
    public function test_user_block() {
        ...
        // Export the data.
        $this->export_context_data_for_user($user->id, $context, 'block_html_placeholders');
    ...
    public function test_user_multiple_blocks_exported() {
        ...
        $approvedlist = new approved_contextlist($user, 'block_html_placeholders', $contextlist->get_contextids());
    ...
    public function test_get_users_in_context() {
        ...
        $component = 'block_html_placeholders';
        $title = 'Block title';
        ...
        \block_html_placeholders\privacy\provider::get_users_in_context($userlist);
    ...
    public function test_delete_data_for_users() {
        ...
        \block_html_placeholders\privacy\provider::get_users_in_context($userlist1);
        $userlist2 = new \core_privacy\local\request\userlist($context2, $component);
        \block_html_placeholders\privacy\provider::get_users_in_context($userlist2);
        ...
        $approvedlist = new approved_userlist($context1, 'block_html_placeholders', $userlist1->get_userids());
