 ...
 * @return void
 */
function block_html_placeholders_global_db_replace($search, $replace) {
    global $DB;
 ...
 */
function block_html_placeholders_get_path_from_pluginfile(string $filearea, array $args) : array {
